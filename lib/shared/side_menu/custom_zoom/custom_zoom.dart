...
class _ZoomDrawerState extends State<ZoomDrawer>
  ...
  ColorTween _overlayColor = ColorTween(
  ...
  Widget _zoomAndSlideContent(
    ...
    switch (_state) {
      ...
      case DrawerState.open:
        slidePercent = 1.0;
        // scalePercent = 1.0;
        scalePercent = widget.isRtl ? 0.83 : 0.8;
    ...
    return Transform(
      transform: Matrix4.translationValues(slideAmount, _yAxis, 0.0)
  ...
  Widget get mainScreenContent {
    ...
    if (widget.shrinkMainScreen) {
      ...
      _mainScreenContent = SizedBox(width: mainSize, child: _mainScreenContent);
    }
  ...
  Widget renderStyle1() {
    final slidePercent = widget.isRtl
      ...
      children: [
        ...
        AnimatedBuilder(
          ...
          builder: (_, __) => _zoomAndSlideContent(
            AbsorbPointer(absorbing: isDrawerOpen, child: mainScreenContent),
            isMain: true,
          ),
        ),
      ],
      ...
      builder: (context, child) {
        ...
        return Stack(
          children: [
            ...
            Transform.translate(
              offset: Offset(-left, 0),
              child: SizedBox(width: rightSlide, child: widget.menuScreen),
            ),
          ],
        );
      },
